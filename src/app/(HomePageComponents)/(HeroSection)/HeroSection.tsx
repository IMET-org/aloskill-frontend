...
//   { label: "Career", path: "/career-path" },
//   { label: "Earn Together", path: "/earn-with-us" },
// ];
...
//         {/* Quick Action Pills */}
//         {/* <div className='flex justify-center pt-6 gap-0'>
//           {tabs.map(({ label, path }, idx) => {
//             // First tab active by default if pathname doesn't match
//             const isActive = pathname === path || (!pathname && idx === 0);
...
//               ${
//                 isActive
//                   ? "bg-[var(--color-orange)] text-white border-transparent"
